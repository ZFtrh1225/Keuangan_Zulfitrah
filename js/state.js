...
(function () {
  ...
  function setTemplates(list) { state.templates = list || []; setCachedTemplates(list); }
  ...
  MT.store = {
    ...
    setDashboard, setTransactions, setGoals, setCategories, setCategoryBudgets, setTemplates, setMonthYear
  };
